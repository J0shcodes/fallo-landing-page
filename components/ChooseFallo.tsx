...
const ChooseFallo = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`${
          hovered ? "scale-x-105 w-[90%] lg:h-[69rem] md:h-[57rem] h-[46rem]" : "lg:w-[68.35rem] md:w-[34.35rem] w-[21.6875rem] lg:h-[73rem] md:h-[61rem] h-[50rem]"
        }  bg-[#1789fc] lg:rounded-[2.5rem] md:rounded-3xl rounded-2xl absolute z-40 `}
      ></div>
      <div
        className={`${
          hovered ? "scale-x-105 w-[80%] lg:h-[73rem] md:h-[60rem] h-[48.5rem]" : "lg:w-[64.35rem] md:w-[30.35rem] w-[18.6875rem] lg:h-[78.25rem] md:h-[64.125rem] h-[52rem]"
        } bg-[#b7dafe] lg:rounded-[2.5rem] md:rounded-3xl rounded-2xl absolute z-30`}
      ></div>
      <div></div>
    </div>
  );
