...
const Testimonials = () => {
  return (
    <div className="lg:h-[110.75rem] lg:pt-[5.625rem] pt-[1.4375rem] pb-[3.6875rem] relative overflow-hidden bg-red-500">
      ...
      <div className="lg:mt-[7.125rem] grid grid-cols-6 lg:gap-y-[2.875rem] gap-y-[8.375rem] md:gap-x-10 lg:px-[7rem] px-[2.375rem] bg-green-500 h-full">
        <div className="bg-orange-500 lg:col-start-1 lg:col-end-3 md:col-span-3 col-span-6 h-fit w-[23.625rem]">
          <div className="bg-[#0a3a6a] max-w-full h-[26.7rem] flex flex-col justify-center items-center rounded-3xl px-4 pt-[2.125rem] pb-4 relative overflow-hidden">
        ...
        <div className="lg:col-span-2 lg:col-end-7 md:col-span-3 col-span-6 bg-orange-500 h-fit w-[23.625rem]">
          <div className="bg-[#0a3a6a] max-w-full h-[26.7rem] flex flex-col justify-center items-center rounded-3xl px-4 pt-[2.125rem] pb-4 relative overflow-hidden">
            <div className="text-[#fafafa] mb-6 text-xl relative z-50">
              <div className="text-2xl">
        ...
        <div className="bg-orange-500 col-start-2 col-span-4 lg:block hidden h-fit">
          <div className="bg-[#0a3a6a] flex gap-6 col-start-3 col-span-4 py-4 pl-[1.375rem] rounded-3xl pr-[3.375rem]">
            <Image
            ...
            />
            <div className="text-2xl text-[#fafafa] bg-blue-500 w-[80%]">
              {/* <div className="bg-orange-500"> */}
              <div className="">
                <div className="bg-red-700 text-2xl h-full">
                  Juggling a full-time job, side hustles, and a busy personal
                  life used to leave me feeling constantly overwhelmed. But
                  since downloading Fallo, I&apos;ve been able to take back
                  control of my schedule and achieve a level of productivity I
                  didn&apos;t even know was possible
                </div>
                <p className="mt-4 text-end">-Joe</p>
              </div>
              {/* </div> */}
            </div>
          </div>
        ...
        <div className="lg:col-start-1 lg:col-end-3 md:col-span-3 col-span-6 bg-orange-500 h-fit w-[23.625rem]">
          <div className="bg-[#0a3a6a] col-start-1 col-end-3 max-w-full h-[26.7rem] flex flex-col justify-center items-center rounded-3xl px-4 pt-[2.125rem] pb-4 relative overflow-hidden">
            <Image
        ...
        <div className="lg:col-span-2 lg:col-end-7 md:col-span-3 col-span-6 bg-orange-500 h-fit w-[23.625rem]">
          <div className="bg-[#0a3a6a] col-end-8 col-span-2 max-w-full h-[26.7rem] flex flex-col justify-center items-center rounded-3xl px-4 pt-[2.125rem] pb-4 relative overflow-hidden">
            <Image
